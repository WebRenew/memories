...
4. Re-promote to `canary` only after stable shadow metrics.
...
3. Verify selected workspace contains the expected repo/project scope.
...
- Use project-scoped checks for repo-specific incidents.
