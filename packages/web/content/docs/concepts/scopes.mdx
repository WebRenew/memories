...
<Callout>
This page covers CLI/local scopes (`global` and git project scope). For SDK scopes, use:
`tenantId` (security/database boundary), `userId` (end-user scope), and `projectId`
(optional repo context filter). See [AI SDK Projects](/docs/sdk/projects).
</Callout>
