...
<Callout>
This project ID maps to CLI/MCP project scope. In SDK integrations, the same value can be
used as `projectId` (optional repo context filter), while `tenantId` remains the
security/database boundary.
</Callout>
