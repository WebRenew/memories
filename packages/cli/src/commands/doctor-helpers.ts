...
export type DoctorCheckCategory = "config" | "database" | "mcp" | "cloud" | "project" | "data";
...
export const REQUIRED_FTS_TRIGGERS = ["memories_ai", "memories_ad", "memories_au"] as const;
...
export function normalizeRemediation(remediation: string[] | undefined): string[] {
...
export function buildNextSteps(checks: DoctorCheckResult[]): string[] {
